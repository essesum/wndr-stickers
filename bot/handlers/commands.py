...
в одиночку не убрать: нужны шестеро. Удаление окончательное — передумал,
просто сделай новый.
"""
...
Стикеры выходят в двух характерах вперемешку: сдержанная классика \
(базовая тройка, чистая плашка) и нарядный разброс (оттенки, картинки-мотивы, \
акценты). Там, где есть розы, чёрный не используется вовсе — его роль играет \
ржавый.
"""
